  ...
  return (
    <footer className="border-t border-glass-border py-8 px-4 text-center">
      <div className="flex items-center justify-center gap-6 mb-4">
        ...
        <a href="mailto:yourmail@gmail.com" className="text-muted-foreground hover:text-foreground transition-colors">
      ...
      <p className="text-sm text-muted-foreground">© 2026 Pavan Sai</p>
    </footer>
  );
};
